			...
			<div className="fluid-container mx-auto">
				<div className="container ">
					...
					<div className="list mt-4">
						<h3 className="title">
							Developer Student Clubs Listing
						</h3>
						<p className={styles.head}>
							Connect with communities, the people and help each
							to make the sustainable and better world
						</p>
						{isLoading ? (
							<div
								className={`col-12 text-center ${styles.load}`}
							>
								<img
									className="img-fluid"
											...
											>
												...
												>
													...
													<div>
														{dsc.domains ? (
															<span
																className={`badge mr-2 ${styles.bW}`}
															>
																{dsc.domains[0]}
															</span>
														) : null}
														{dsc.domains ? (
															<span
																className={`badge mr-2 ${styles.bM}`}
															>
																{dsc.domains[1]}
															</span>
														) : null}
														{dsc.domains ? (
															<span
																className={`badge mr-2 ${styles.bC}`}
															>
																{dsc.domains[2]}
															</span>
														) : null}
														{dsc.domains ? (
															<span
																className={`badge mr-2 ${styles.bF}`}
															>
																{dsc.domains[3]}
															</span>
														) : null}
